...
public class Camelidc {
    ...
    public static void main(String[] args) {
        ...
        headers.put("Origin", "http://camelidc.net");
        headers.put("Host", "camelidc.net");
        headers.put("Referer", "http://camelidc.net/user/login.php");

        StringBuilder sb = new StringBuilder();
        HttpResponse post = HttpClientUtils.post("http://camelidc.net/user/_login.php", params, headers);
        ...
        String html = HttpClientUtils.getHtml("http://camelidc.net/user/_checkin.php", new HashMap<String, String>(),
                sb);
